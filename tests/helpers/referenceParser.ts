/**
 * tests/helpers/referenceParser.ts
 *
 * Authoritative reference implementation / oracle of the incremental SSE Parser
 * strictly matching WHATWG SSE specification and PROJECT.md contract.
 */
